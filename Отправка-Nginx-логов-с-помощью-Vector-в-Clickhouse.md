...
Vector, предназначенной для сбора, преобразования и сохранения данных логов, метрик и событий.
...
Будем настраивать связку Nginx (Access logs) -> Vector (Client | Filebeat) -> Vector (Server | Logstash) -> Clickhouse. Установим 4 сервера.
...
Так же если вам нужен GeoIP, то скачайте базу Maxmind и положите в /opt/geoip/GeoLite2-City.mmdb.
