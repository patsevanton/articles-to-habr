...
По официальной инструкции я не смог установить Reportportal. Пример [issue](https://github.com/reportportal/kubernetes/issues/193). Поэтому написал этот пост.
