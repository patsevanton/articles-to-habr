...
![](https://habrastorage.org/webt/lf/bp/zt/lfbpztntfaxlwcsi0gptbg1ltqm.png)
...
Ключевой результат заключается в том, что когда имеется сообщение о коммите, то это сообщение в конечном итоге окажется в разделе изменений VCS. Частота с которой эти сообщения о коммитах подбираются может быть указана с использованием нотацию cron, вот здесь, так что вы можете выбрать "каждые 10 минут" или "каждый час".
...
![](https://habrastorage.org/webt/6v/ge/rc/6vgercn5yu7stnlx9y6hjbjsbdm.png)
