...
Самая интересная утилита

[binenv](https://github.com/devops-works/binenv) - **утилита для установки популярных программ в linux, но которых нет в пакетном менеджере.**
