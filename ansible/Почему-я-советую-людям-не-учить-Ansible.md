Кто из вас использует Ansible и пришел посмотреть, что не так со мной? Слайды будут на английском, но я буду все проговаривать, поэтому не переживайте. Максим сейчас в Телеграм-канале запустит опросник, вы можете на него ответить. 

![](https://habrastorage.org/webt/3y/0w/0o/3y0w0o8lasidtvwqy277tyqntx8.png)

Кто-то все-таки пришел.
...
Мы видим из этой страницы, что его можно использовать для application deployment, менеджмента конфигурации, чтобы оркестрировать таски. И это все работает либо через OpenSSH, либо WinRM. 
...
Приведу вам несколько примеров. Например, вам могло прийти письмо счастье от AWS о том, что железо, на котором лежит ваше <font color="red">…</font> , деградировало, и они собираются его прибить. И если у вас там такой сервер-снежинка, то день может стать намного интересней, чем он был. 
...
- У нас есть возможность масштабироваться быстро. Например, в рамках AWS у нас есть auto scaling группа. Вам нужно поднимать новые виртуалки. И вы не будете руками их запускать-запускать, а потом инструментом синхронизации конфигурации их настраивать, а потом только вводить в строй. Если у вас почти все заключено в <font color="red">…</font>, то тогда у вас auto scaling group может автоматически вам новые сервера легко поднимать, а также убивать. Вы ничего не теряете, потому что они всегда все одинаковые. Ничего нового здесь я не рассказываю.
...
<font color="red">…</font> все больше набирает популярность, чтобы давать серверам identity. И потом, чтобы они могли через identity аутентифицироваться в других системах. 

Другой вариант – вы можете спрятать зашифрованные секреты в образ с учетом того, что ключ шифрования будет доступен, когда образ будет подниматься. Например, в AWS вы можете использовать ключ, который доступен только в вашем аккаунте. Если ваш IAM утек, то его нельзя будет расшифровать, потому что нет доступа к ключу. В вашем дата-центре может быть <font color="red">…</font>, в котором вы можете хранить hardware security module и в котором вы можете хранить ключи шифрования, которые будете использовать для того, чтобы расшифровывать секреты. Если у вас утечет образ, то ничего страшного, потому что ключи только там. 
...
Чему мы можем научиться от Kubernetes? Давайте задумаемся. Kubernetes принес достаточно интересную концепцию как reconciliation <font color="red">…</font>, т. к. когда вы ему скармливаете свои <font color="red">…</font>, он их принимает, персистит etcd и потом пытается сделать так, чтобы было так, как описано. Он постоянно идет по кругу и проверяет – а оно так, а оно так? Например, pod убили, pod нет. И он поднимает новый, чтобы было так, как описано. 
...
Например, я вел 10 лет назад миграции с <font color="red">…</font> на Git. И в больших организациях это мероприятие занимало года полтора, потому что очень много было построено вокруг него.  
...
\-   Т. е. здесь ты говоришь, что у тебя нет возможности пойти обратно? Т. е. если ты уже поднял новую Mongo, то возможности пойти обратно у тебя уже нет?
...
\-   (Владимир) Андрей, Максим, спасибо большое! У нас, к сожалению, заканчивается время. Мы только что услышали про то, что Ansible не нужен. 
